...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.5\linewidth}
    ...
    \label{fig:sin_hundertzwanzig_nullsiebenacht}
  \end{subfigure}
  \begin{subfigure}[b]{0.35\linewidth}
  \def\svgwidth{220px}
    \input{assets/main/sin_null_cos_null_einheitskreis.path.pdf_tex}
	\caption{$sin(310°) \approx -0,77$}
	\label{fig:sin_dreihunderzehn_minusnullsiebensieben}
  \end{subfigure}
...
Sinusfunktion im Gradmaß: sinus berechnen und werte einzeichen...

\subsection{Mit dem Sinus modellieren - Aufgabe - Einen Zeitlichen Vorgang modellieren}
\subsection{Mit dem Sinus modellieren - Aufgabe}
S.103
