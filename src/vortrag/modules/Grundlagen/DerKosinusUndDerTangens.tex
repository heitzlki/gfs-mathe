...
\begin{frame}{Sinus von $\alpha$}
  ...
  \only<2>{
    \begin{figure}[hb!]
      ...
      \input{tmp/rechtwinkliges_dreieck_sinus.path.svg.pdf_tex}
      \caption{Rechtwinkliges Dreieck}
      \label{fig:rechtwinkliges_dreieck_sinus_gegenkathete}
    \end{figure}
  }
  ...
  \only<3->{
    \begin{figure}[hb!]
      ...
      \input{tmp/rechtwinkliges_dreieck_sinus.path.svg.pdf_tex}
      \caption{Rechtwinkliges Dreieck}
      \label{fig:rechtwinkliges_dreieck_sinus_hypotenuse}
    \end{figure}
  }
\end{frame}
...
\begin{frame}{Cosinus von $\alpha$}
  ...
  \only<3->{
    \begin{figure}[hb!]
      ...
      \input{tmp/rechtwinkliges_dreieck_sinus.path.svg.pdf_tex}
      \caption{Rechtwinkliges Dreieck}
      \label{fig:rechtwinkliges_dreieck_cosinus_hypotenuse}
    \end{figure}
  }
\end{frame}
...
\begin{frame}{Tangens von $\alpha$}
  ...
  \only<3->{
    \begin{figure}[hb!]
      ...
      \input{tmp/rechtwinkliges_dreieck_sinus.path.svg.pdf_tex}
      \caption{Rechtwinkliges Dreieck}
      \label{fig:rechtwinkliges_dreieck_tangens_ankathete}
    \end{figure}
  }
\end{frame}
