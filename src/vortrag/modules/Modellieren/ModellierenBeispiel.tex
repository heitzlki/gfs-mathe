...
\begin{frame}{L{"o}sung}
  ...
  \only<1>{
    \begin{figure}[hb!]
      \center
      \def\svgwidth{150px}
      \input{tmp/schaufelraddamper_60.path.svg.pdf_tex}
      \caption{Schaufelraddampfer}
      \label{fig:schaufelraddamper_60}
    \end{figure}
  }
...
\begin{frame}{L{"o}sung}
  ...
  \only<1-6>{
    \begin{figure}[hb!]
      \center
      \def\svgwidth{150px}
      \input{tmp/schaufelraddamper_180.path.svg.pdf_tex}
      \caption{Schaufelraddampfer}
      \label{fig:schaufelraddamper_180}
    \end{figure}
  }
...
\begin{frame}{L{"o}sung}
  ...
  \onslide<1->{
    \begin{figure}[hb!]
      \center
      \def\svgwidth{150px}
      \input{tmp/schaufelraddamper_360.path.svg.pdf_tex}
      \caption{Schaufelraddampfer}
      \label{fig:schaufelraddamper_360}
    \end{figure}
  }
\end{frame}
