...
\begin{frame}{a) L{"o}sung}
  ...
  \onslide<5->{Daraus Folgt $\alpha = t \cdot 30^\circ$ (t in h).}
  \begin{align}
    \onslide<6->{\alpha & = t \cdot 30^\circ \nonumber \\}
    \onslide<7->{\alpha & = 5 \cdot 30^\circ \tag{1} \\}
    \onslide<8->{\alpha & = 150^\circ \tag{2} \\[-\baselineskip]\notag}
  \end{align}
  \onslide<9->{F{"u}r t = 5 erh{"a}lt man $\alpha = 150^\circ$}
\end{frame}
