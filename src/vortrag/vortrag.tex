...
\usepackage{cancel} %Für Strich durch Gleichungen (kürzen)
...
% Improve pdflatex render time
\input{modules/Grundlagen/Grundlagen.tex} 
\input{modules/Einheitskreis/Enheitskreis.tex}
\input{modules/Modellieren/Modellieren.tex}
%\input{modules/Anwendung/Anwendung.tex}
%\input{modules/Zusammenfassung/Zusammenfassung.tex}
%\input{modules/Quellen/Quellen.tex}
