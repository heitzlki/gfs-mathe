...
%	\begin{figure}[h!]
%		\input{./title.path.pdf_tex} %Grafik muss 220mm breit sein
%	\end{figure}
%\end{textblock}
\newpage
...
\input{modules/Rückblick/Rückblick.tex}
...
\begin{figure}[hb!]
	\center
	\def\svgwidth{500px}
	\input{assets/main/sinuswelle.path.pdf_tex}
...
\begin{figure}[hb!]
	\center
	\def\svgwidth{500px}
	\input{assets/main/sinuswelle_zeichnen.path.pdf_tex}
...
\begin{figure}[hb!]
	\centering
	\def\svgwidth{150px}
	%\input{assets/main/alpha_0.path.pdf_tex}
	\input{assets/main/sin_310_-_077.path.pdf_tex}
	\caption{$\alpha = 0°$}
	\label{fig:alpha_0}
\end{figure}
